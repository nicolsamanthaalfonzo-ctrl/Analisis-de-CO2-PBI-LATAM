# ==============================================================================
# PROYECTO FINAL: Análisis Profundo de Desacoplamiento CO2 vs PBI
# Script: scripts/04_analisis_final.R
# ==============================================================================
...
# Exportar tabla analítica a la carpeta data/
...
# Guardar la nueva figura en la carpeta figures/
